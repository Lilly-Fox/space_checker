...
def _Skymapper_phot(ra,dec,size):
    ...
    return fig,wcsList,og_size*2,images[1]
    ...
    try:
        ...
        for v in val:
            if 3 in v:
                ...
                ty += [2]
        result['star'] = ty
        result = result.rename(columns={'mag_psf_g':'gmag','mag_psf_r':'rmag',
                                        'mag_psf_i':'imag','mag_psf_z':'zmag',
                                        'magerr_psf_g':'e_gmag', 'magerr_psf_r':'e_rmag',
                                        'magerr_psf_i':'e_imag', 'magerr_psf_z':'e_zmag'})
        return result
